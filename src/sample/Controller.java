...
public class Controller {
    ...
    public ArrayList<Carnivore> get_list_carnivore(){
        return (ArrayList<Carnivore>) this.listeCarnivore.clone();
    }

    public ArrayList<Herbivore> get_list_herbivore(){
        return (ArrayList<Herbivore>) this.listeHerbivore.clone();
    }

    public ArrayList<Point_eau> get_list_Point_eau(){
        return (ArrayList<Point_eau>) this.listePoint_eau.clone();
    }

    public void gen_ecosyst(int nb_carnivore, int nb_herbivore, int nb_charognard, int nb_eau, int taille_eau_max,int taille_ter){
